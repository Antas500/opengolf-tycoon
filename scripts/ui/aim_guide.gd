...
func _draw_outlined_text(font: Font, draw_position: Vector2, text: String, color: Color,
		font_size: int = LABEL_FONT_SIZE) -> void:
	font.draw_string_outline(get_canvas_item(), draw_position, text, HORIZONTAL_ALIGNMENT_LEFT, -1,
